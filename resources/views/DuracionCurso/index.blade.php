...
<div class="container">
    ...
    <div class="card-header d-inline-flex">
        ...
        <a href="{{ url('DuracionCurso/pdf?search=' . request('search')) }}" class="btn btn-success" target="_blank">PDF</a>
    </div>
    <br>
    <div class="card mt-3">
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="Basic example">
                           <!-- <a href="" class="btn btn-info"> <i class="fa fa-eye" aria-hidden="true"></i></a>-->
                            ...
                            <a href="{{url('/DuracionCurso/'.$Duracioncursos->id.'/edit') }}" class="btn btn-warning"><i class="fa fa-pencil-alt"></i></a>

                             <form action="{{ url('/DuracionCurso/'.$Duracioncursos->id)}}" class="d-inline" method="post">
                                @csrf
                                {{method_field('DELETE')}}
